...
namespace Pro_ject {
	...
	/// <summary>
	/// Summary for OneWay_Single
	/// </summary>
	public ref class OneWay_Single : public System::Windows::Forms::Form
	{
	public:
		OneWay_Single(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->comboBox2->Items->AddRange(gcnew cli::array< System::Object^  >(6) {L"Canada", L"Ustralia", L"France", L"Saudia Arabia", 
				L"Maroco", L"Oman"});
			this->comboBox2->Location = System::Drawing::Point(19, 89);
			...
			this->comboBox3->Items->AddRange(gcnew cli::array< System::Object^  >(5) {L"Cairo", L"Alexandria\t", L"Aswan", L"Sharm El-Shekh", 
				L"Suez Canal"});
			this->comboBox3->Location = System::Drawing::Point(19, 32);
			...
			this->comboBox1->Location = System::Drawing::Point(19, 270);
			...
			this->panel1->Size = System::Drawing::Size(326, 321);
			...
			this->button1->Click += gcnew System::EventHandler(this, &OneWay_Single::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Font = (gcnew System::Drawing::Font(L"Tahoma", 11.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->button2->Location = System::Drawing::Point(85, 346);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(75, 35);
			this->button2->TabIndex = 20;
			this->button2->Text = L"SUBMIT";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &OneWay_Single::button2_Click);
			// 
			// OneWay_Single
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(348, 387);
			this->Controls->Add(this->button2);
			this->Controls->Add(this->panel1);
			this->Controls->Add(this->button1);
			this->Name = L"OneWay_Single";
			this->Text = L"OneWay_Single";
