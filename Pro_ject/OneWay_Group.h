...
namespace Pro_ject {
	...
	/// <summary>
	/// Summary for OneWay_Group
	/// </summary>
	public ref class OneWay_Group : public System::Windows::Forms::Form
	{
	public:
		OneWay_Group(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->panel2->Location = System::Drawing::Point(11, 101);
			...
			this->comboBox3->Items->AddRange(gcnew cli::array< System::Object^  >(6) {L"Canada", L"Ustralia", L"France", L"Saudia Arabia", 
				L"Maroco", L"Oman"});
			this->comboBox3->Location = System::Drawing::Point(22, 127);
			...
			this->comboBox1->Location = System::Drawing::Point(22, 205);
			...
			this->label4->Location = System::Drawing::Point(22, 172);
			...
			this->label5->Location = System::Drawing::Point(22, 94);
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"Tahoma", 11.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->button1->Location = System::Drawing::Point(397, 364);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(75, 35);
			this->button1->TabIndex = 17;
			this->button1->Text = L"NEXT";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &OneWay_Group::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Font = (gcnew System::Drawing::Font(L"Tahoma", 11.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->button2->Location = System::Drawing::Point(291, 364);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(75, 35);
			this->button2->TabIndex = 19;
			this->button2->Text = L"SUBMIT";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &OneWay_Group::button2_Click);
			// 
			// OneWay_Group
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(762, 410);
			this->Controls->Add(this->button2);
			this->Controls->Add(this->panel2);
			this->Controls->Add(this->groupBox1);
			this->Controls->Add(this->button1);
			this->Name = L"OneWay_Group";
			this->Text = L"OneWay_Group";
